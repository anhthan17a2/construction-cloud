    ...
    callbacks: {
        ...
        async signIn ({ user, account }) {
            if (account?.provider === "google" && user.email) {
                const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.findUnique({
                    where: {
                        email: user.email
                    }
                });
        ...
        async jwt ({ token, user, trigger, session }) {
            ...
            if (token.id) {
                const fresh = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.findUnique({
                    where: {
                        id: token.id
                    },
                    select: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__983e7f._.js.map